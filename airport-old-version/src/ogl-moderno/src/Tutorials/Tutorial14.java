...
public class Tutorial14 {
    ...
    public void run() {
        System.out.println("Hello LWJGL " + Sys.getVersion() + "!. Tutorial 14");
...
static final String VertexShaderSrc = 
    ...
    private void initGL() {
        ...
        // Create the window
        window = glfwCreateWindow(WIDTH, HEIGHT, "Tutorial 14", NULL, NULL);
        if (window == NULL) {
    ...
    private void drawTriangle1() {
            /* Render triangle */
            float posZ = -2 + (float)Math.cos(count);
            Matrix4f model = Matrix4f.translate(0, 0, posZ);
