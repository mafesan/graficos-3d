...
public class Tutorial11 {
    ...
    public void run() {
        System.out.println("Hello LWJGL " + Sys.getVersion() + "!. Tutorial 11");
...
static final String VertexShaderSrc = 
    ...
    private void initGL() {
        ...
        // Create the window
        window = glfwCreateWindow(WIDTH, HEIGHT, "Tutorial 11", NULL, NULL);
        if (window == NULL) {
    ...
    private void loop() {
        ...
        while (glfwWindowShouldClose(window) == GL_FALSE) {
            ...
            /* Render triangle */
            count += 0.3f;
            Matrix4f model = Matrix4f.rotate(count, 0, 0, 1);
