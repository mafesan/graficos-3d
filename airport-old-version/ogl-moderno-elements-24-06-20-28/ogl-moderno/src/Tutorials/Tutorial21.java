 ...
 * @author Agustin
 */
public class Tutorial21 implements Drawable
{
    private ShaderProgram shaderProgram;
    private final OpenGLHelper openGLHelper = new OpenGLHelper("Tutorial 21");
    ...
    private void prepareBuffers() {
        ...
        // ----------------------- TEXTURE IMAGE -----------------------------//
        texture0 =  Texture.loadTexture("grass.png");
    ...
    private void drawCube1() {
        ...
        model = Matrix4f.translate(2, 5, 0).multiply(model);
