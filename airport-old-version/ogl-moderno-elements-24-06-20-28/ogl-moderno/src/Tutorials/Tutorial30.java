 ...
 * @author Agustin
 */
public class Tutorial30 implements Drawable {

    private ShaderProgram shaderProgram;
    private final OpenGLHelper openGLHelper = new OpenGLHelper("Tutorial 30", new FPCameraController(0, 0, -6));
    ...
    public void run() {
        openGLHelper.initGL("VS_ADS_Texture.vs", "FS_ADS_Texture3.fs");
        prepareBuffers();
        initLights();
    ...
    private void prepareBuffers() {
        ...
        int vbo_n = cubeModel.createVerticesBuffer();
        ...
        Texture texture2 = Texture.loadTexture("nicegrass.jpg");
        int uniTex2 = shaderProgram.getUniformLocation("Texture2");
        shaderProgram.setUniform(uniTex2, 1);

        glActiveTexture(GL_TEXTURE2);
        Texture texture3 = Texture.loadTexture("darkrockalpha.png");
        int uniTex3 = shaderProgram.getUniformLocation("Texture3");
