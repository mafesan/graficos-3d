...
public class Tutorial3 {
    ...
    public void run() {
        System.out.println("Hello LWJGL " + Sys.getVersion() + "!. Tutorial 3");
...
"        }";
    ...
    private void initGL() {
        ...
        // A PARTIR DE ESTE PUNTO COMPILAMOS Y PREPARAMOS LOS SHADERS
        
        int vertexShader = glCreateShader(GL_VERTEX_SHADER); // haz sitio para un programa de shader (vertices)
        glShaderSource(vertexShader, VertexShaderSrc);      // en esta variable (VertexShaderSrc) hay un programa
        glCompileShader(vertexShader);                     // compila
        
        // dame el resultado de la compilacion
    ...
    private void loop() {
        ...
        glVertexAttribPointer(posAttrib, 3, GL_FLOAT, false, 3 * FLOAT_SIZE, 0);
